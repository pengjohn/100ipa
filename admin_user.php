...
{
?>
<form method="POST" action="admin_user_login.php">
...
<div>
	<table border="0" cellspacing="1" width=400>
		...
		<tr>
			<td align="right"><a href=admin_user_new.php>注册</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
else
{
   ...
   echo "&nbsp;&nbsp;&nbsp;[<a href=admin_user_logout.php>登出</a>]<br><br>";
   echo "<a href=admin_news_add.php>[游戏推荐管理]</a><br>";
}
?>
</body>
</html>
